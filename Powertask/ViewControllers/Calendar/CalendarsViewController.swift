...
class CalendarsViewController: UIViewController {
   ...
   //TODO:  transformar todo a los nuevos datos
    var events = [PTEvent(name: "Examen 1",
                        type: EventType.exam,
                        startDate: Date.now,
                        subject: PTSubject(name: "iOS", color: .purple)),
                  ...
                  PTEvent(name: "Día de la Almudena", type: EventType.vacation, startDate: Date.now.addingTimeInterval(20343), subject: PTSubject(name: "Acceso a datos", color: .systemIndigo)),
                  PTEvent(name:"Examen de mates", type: EventType.exam, startDate: Date.now.addingTimeInterval(86400), subject: PTSubject(name: "Acceso a datos", color: .green)),
                  PTEvent(name: "Examen 2",
                                      type: EventType.exam,
                                      startDate: Date.now.addingTimeInterval(8640),
                        subject: PTSubject(name: "iOS", color: .orange)),
